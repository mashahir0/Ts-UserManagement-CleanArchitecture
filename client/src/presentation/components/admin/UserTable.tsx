...
// import { useGetUsersQuery } from "../../../data/api/adminApi";
...
//               <td className={`p-3 text-center font-bold ${user.status === "Active" ? "text-green-400" : "text-red-400"}`}>
//                 {user.status}
//               </td>
//               <td className="p-3 flex justify-center space-x-3">
//                 <button onClick={() => handleEdit(user.id)} className="text-blue-400 hover:text-blue-500">
//                   <Edit className="w-5 h-5" />
//                 </button>
//                 <button onClick={() => handleBlock(user.id)} className={`hover:text-yellow-500 ${user.status === "Active" ? "text-yellow-400" : "text-green-400"}`}>
//                   <Ban className="w-5 h-5" />
//                 </button>
//                 <button onClick={() => handleDelete(user.id)} className="text-red-400 hover:text-red-500">
